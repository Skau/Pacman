...
Enemy::Enemy(sf::Image & image, std::weak_ptr<Tile> SpawnTile, std::weak_ptr<Map> MapIn, Game & game) : Entity{image, SpawnTile, game}, map{ MapIn }
{
...
void Enemy::findPath(std::shared_ptr<Tile> startTile, std::shared_ptr<Tile> endTile)
{
...
void Enemy::findNeighbouringTiles(std::shared_ptr<Tile> currentTile, std::shared_ptr<Tile> TileToCheck, std::shared_ptr<Tile> endTile)
{
...
bool Enemy::findElementClosedTiles(std::shared_ptr<Tile> TileToCheck)
{
...
bool Enemy::findElementPathToMoveTiles(std::shared_ptr<Tile> TileToCheck)
{
	std::vector<std::shared_ptr<Tile>>::iterator it;
...
bool Enemy::findElementOpenTiles(std::shared_ptr<Tile> TileToCheck)
{
	std::vector<std::shared_ptr<Tile>>::iterator it;
